...
<p align="justify">
Este projeto apresenta o desenvolvimento de um novo sistema de Crud Clientes, com microserviços do ultimo projeto de Pós Tech FIAP 
</p>
...
`Funcionalidade 2:` Listagem de CLientes
